...
const TrackingPerformanceController = require("../Controllers/TrackingPerformanceController");
...
module.exports = function (express) {
  ...
  /*
    |--------------------------------------------------------------------------
    |  TrackingPerformance Routes
    |--------------------------------------------------------------------------
    */
  router.get("/TrackingPerformance", TrackingPerformanceController.fetch);
